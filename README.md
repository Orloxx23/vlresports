...
Please refer to the <a href="https://vlr.orlandomm.net/docs">API documentation</a> for more detailed usage instructions and examples. If you want more technical documentation, you can go to <a href="https://deepwiki.com/Orloxx23/vlresports">Deep Wiki/vlresports</a>
